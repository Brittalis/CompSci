...
//	private boolean disabled = false;
	...
	public boolean isBroken()
	{
		...
		{
			System.out
					.println("the lock is broken and all other functionality is disabled untill it is reset");
		}
	...
	public void setCombination()
	{
		...
		System.out
				.println("please enter the first digit of your new combination");
		combination[0] = this.input.nextInt();
		System.out
				.println("please enter the second digit of your new combination");
		combination[1] = this.input.nextInt();
		System.out
				.println("please enter the third digit of your new combination");
	...
	public boolean checkCombination(int[] combination)
	{
		...
		{
			if (combination[i] < this.minValue
					|| combination[i] > this.maxValue)
			{
				System.out
						.println("Your Combination is Invalid, all digits mus be between "
								+ this.minValue
								+ " and "
								+ this.maxValue
	...
	public void changeMinMax()
	{
		...
		{
			System.out
					.println("please enter a maximum larger than your minumum");
			this.maxValue = this.input.nextInt();
		}
		System.out.println();
